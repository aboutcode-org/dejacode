...
"""
Local copy of `django.conf.locale.LANG_INFO`.

Keeping a local copy to avoid the need for database migration when the LANG_INFO is
updated on the Django side.
