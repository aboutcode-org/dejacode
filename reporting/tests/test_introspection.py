...
class ModelIntrospectorTestCase(TestCase):
    ...
    def test_reporting_grouped_fields_feature_respects_whitelist(self):
        expected = [
            ...
            {"group": "Direct Fields", "label": "guidance_url",
                "value": "guidance_url"},
            ...
            {"group": "Direct Fields", "label": "is_exception",
                "value": "is_exception"},
            ...
            {"group": "Direct Fields", "label": "license_profile >>",
                "value": "license_profile"},
            {"group": "Direct Fields", "label": "license_status >>",
                "value": "license_status"},
            {"group": "Direct Fields", "label": "license_style >>",
                "value": "license_style"},
            ...
            {"group": "Direct Fields", "label": "publication_year",
            ...
            {"group": "Direct Fields", "label": "spdx_license_key",
                "value": "spdx_license_key"},
            {
                "group": "Direct Fields",
                "label": "special_obligations",
                "value": "special_obligations",
            },
            {"group": "Direct Fields", "label": "standard_notice",
                "value": "standard_notice"},
        ...
        self.assertEqual(
            expected, model_data["license_library:license"]["grouped_fields"])
    ...
    def test_reporting_get_model_field_via_field_traversal(self):
        ...
        input = [
            ...
            # M2M Relationship
            ("componentassignedpackage", Component._meta.get_field(
                "componentassignedpackage")),
            ("componentassignedpackage__id",
             ComponentAssignedPackage._meta.get_field("id")),
            (
    ...
    def test_reporting_model_data_fields_whitelist(self):
        ...
        self.assertEqual(
            expected, column_template_model_data["dje:dejacodeuser"])
