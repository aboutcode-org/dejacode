...
define([
    ...
    var initialContentType = nexb.App.client_data.content_type_map[$('#id_content_type').val()];

    var FilterInlineForm = nexb.ContentTypeAwareInlineForm.extend({
        templateFunction: Ember.Handlebars.compile(filter_inline_form_template_source),
        init: function () {
        ...
        fieldNameName: function () {
            return _s.sprintf('%s-%s-field_name', this.get('formsetPrefix'), this.get('formsetIndex'));
        ...
        // Lookup
        lookupName: function () {
            return _s.sprintf('%s-%s-lookup', this.get('formsetPrefix'), this.get('formsetIndex'));
        }.property('formsetPrefix', 'formsetIndex'),
        lookupValue: null,
        ...
        // Value
        valueName: function () {
            return _s.sprintf('%s-%s-value', this.get('formsetPrefix'), this.get('formsetIndex'));
        }.property('formsetPrefix', 'formsetIndex'),
        valueValue: '',

        // Runtime Parameter
        runtimeParameterName: function () {
            return _s.sprintf('%s-%s-runtime_parameter', this.get('formsetPrefix'), this.get('formsetIndex'));
        }.property('formsetPrefix', 'formsetIndex'),
        ...
        // Negate (NOT)
        negateName: function () {
            return _s.sprintf('%s-%s-negate', this.get('formsetPrefix'), this.get('formsetIndex'));
        }.property('formsetPrefix', 'formsetIndex'),
        negateValue: false,
    ...
    var OrderFieldInlineForm = nexb.ContentTypeAwareInlineForm.extend({
        templateFunction: Ember.Handlebars.compile(order_field_inline_form_template_source),
        init: function () {
            var initialData = this.get('initialData');
            if (! Ember.isNone(initialData)) {
        ...
        fieldNameContent: function () {
            return nexb.App.client_data.order_field_model_data[this.get('contentType')]['fields'];
        ...
        // Sort
        sortName: function () {
            return _s.sprintf('%s-%s-sort', this.get('formsetPrefix'), this.get('formsetIndex'));
        }.property('formsetPrefix', 'formsetIndex'),
        sortValue: null,
        sortSelect: function () {
            var controller = this;
        ...
        // Seq
        seqName: function () {
            return _s.sprintf('%s-%s-seq', this.get('formsetPrefix'), this.get('formsetIndex'));
        }.property('formsetPrefix', 'formsetIndex'),
        seqValue: null,
    ...
    var OrderFieldInline = nexb.ContentTypeAwareInline.extend(nexb.DraggableRowsInlineMixin, {
        templateFunction: Ember.Handlebars.compile(order_field_inline_template_source),
        formsetPrefix: nexb.App.client_data.order_field_formset_prefix,
        initialFormCount: nexb.App.client_data.order_field_formset_initial_form_count,
        getInitialInlineData: function () {
