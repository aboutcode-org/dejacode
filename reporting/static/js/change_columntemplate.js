...
define([
    ...
    var ColumnTemplateAssignedFieldInlineForm = nexb.ContentTypeAwareInlineForm.extend({
        templateFunction: Ember.Handlebars.compile(column_template_assigned_field_inline_form_template_source),
        init: function () {
        ...
        displayNameName: function () {
            return _s.sprintf('%s-%s-display_name', this.get('formsetPrefix'), this.get('formsetIndex'));
        }.property('formsetPrefix', 'formsetIndex'),
        displayNameValue: '',
    ...
    var ColumnTemplateInline = nexb.ContentTypeAwareInline.extend(nexb.DraggableRowsInlineMixin, {
        templateFunction: Ember.Handlebars.compile(column_template_assigned_field_inline_template_source),
        formsetPrefix: nexb.App.client_data.column_template_assigned_field_formset_prefix,
        initialFormCount: nexb.App.client_data.column_template_assigned_field_formset_initial_form_count,
        hasErrors: function () {
            return nexb.App.client_data.column_template_assigned_field_formset_formset_has_errors;
        }.property(),
