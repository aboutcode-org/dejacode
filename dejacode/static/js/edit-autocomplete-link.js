    ...
    $(document).ready(function(){
        NEXB.install_edit_autocomplete_links = function(elem) {
            ...
            elem.find('.ui-autocomplete-input').each(function(){
                ...
                var add_link = $('<a id="add_'+field_id+'" href="' + add_href + 'add/?_to_field=id&amp;_popup=1" class="grp-related-widget-wrapper-link grp-add-related grp-add-another related-widget-wrapper-link add-related add-another raw-id-add" title="Add another"></a>');
                var edit_link = $('<a href="#" class="edit-icon edit-icon-autocomplete" title="Edit item" target="_blank">&nbsp;</a>');
